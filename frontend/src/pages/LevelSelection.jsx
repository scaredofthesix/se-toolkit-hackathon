  ...
  return (
    <div className="min-h-[calc(100vh-80px)] flex flex-col justify-center max-w-7xl mx-auto px-4 sm:px-10 py-8 sm:py-12 fade-in">
      <div className="text-center mb-8 sm:mb-14">
        <p className="font-body italic text-white/50 text-lg sm:text-2xl mb-4">tell us about yourself</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
        {levels.map((l) => (
          <button
            ...
            className="card p-6 sm:p-12 rounded-none text-left group cursor-pointer flex flex-col justify-center min-h-[180px] sm:min-h-[300px]"
          >
            <h2 className="font-display text-2xl sm:text-3xl font-bold mb-3 sm:mb-4">{l.title}</h2>
            <p className="font-body text-white/55 text-base sm:text-xl mb-5 sm:mb-7 leading-relaxed">{l.desc}</p>
